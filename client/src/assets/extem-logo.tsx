...
const ExtemLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 600 200" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <text x="70" y="185" fontSize="22" fontWeight="400" fill="#006DAB" fontFamily="'Arial', sans-serif">Life Education For Everyone</text>
  </svg>
);
